...
const falcon: ProjectMeta = {
  ...
  bookLead: {
    ...
    caption: 'An aircraft take-off line, mirrored twice, becoming the falcon',
  },
  bookRegister: [
    {
      slug: 'falcon',
    ...
    },
    {
      ...
      invert: true,
      caption:
        "Sketches of jets and a take-off diagram, tracing climb angles, flaps and slats that seed the monument's lines",
    },
