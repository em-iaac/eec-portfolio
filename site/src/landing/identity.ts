...
export const BIO: readonly string[] = [
  ...
  // The comma and the "not just" landed at the book audit (Emilie, 2026-08-18):
  // she was shown that both edits touch her own signed lines and ruled "fix
  // both as tabled", knowingly.
